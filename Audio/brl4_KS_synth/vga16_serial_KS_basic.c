 ...
 * ========================================================
 * HARDWARE CONNECTIONS -- not necessary if you only want to hear the sound
 *  - GPIO 16 ---> VGA Hsync
 *  - GPIO 17 ---> VGA Vsync
...
// ===========================================
// dSP definitions -- NOT part of basic KS algo
// ===========================================
//
// FFT setup
...
static PT_THREAD (protothread_graphics(struct pt *pt)) {
    ...
    setCursor(260, 5+14) ;
    writeStringBig("Basic Karplus_Strong ") ;
...
void compute_sample(void)
{
    ...
    // ==== play the KS ===
      ...
      //this is a 1 pole IIR lowpass, which i prefer but
      // is not basic KS
